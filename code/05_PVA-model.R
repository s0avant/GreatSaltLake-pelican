#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
#                 Gunnison Colony Count SSM PVA - Nimble Code                  #
#                                 02/02/2024                                   #
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
library(nimble)
library(dplyr)
...
MCMCvis::MCMCdiag(n_samples$samples,
                  file_name =
                    "output/model-output_post-break_full-without-year_for-PVA.txt")

MCMCvis::MCMCtrace(n_samples$samples,
                   params = target,
                   iter = niter,
                   filename =
                     "output/model-output_post-break_full-without-year_for-PVA.pdf")

write_rds(awpe.ssm.nimble,
          "output/model-output_post-break_full-without-year_for-PVA.RDS")

write_rds(n_samples$samples,
          "output/posteriors/posterior-samples_post-break_full-without-year_for-PVA.RDS")
